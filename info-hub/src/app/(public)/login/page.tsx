      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-background border rounded-2xl shadow-xl p-8 space-y-6">
          <div className="space-y-4">
            ...
            <button className="w-full py-3 bg-primary text-white rounded-lg font-bold hover:scale-[1.02] active:scale-[0.98] transition-all shadow-md">
              Sign In
            </button>
          </div>
          ...
          {/* Lower Section: Microsoft Login */}
          <button className="w-full py-3 border rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
